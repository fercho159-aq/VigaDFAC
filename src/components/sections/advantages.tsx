import { Weight, Leaf, Zap, Recycle, Truck } from 'lucide-react';
...
const advantages = [
  ...
  { icon: Truck, title: 'Entrega Express', description: 'Reciba su pedido en menos de 24 horas en CDMX y Zona Metropolitana.' },
];
      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline">Por qué elegir Vigas H-20</h2>
        ...
        <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:gap-12 lg:max-w-none lg:grid-cols-5 mt-12">
